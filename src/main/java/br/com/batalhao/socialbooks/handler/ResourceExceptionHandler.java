...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<Erro> handlerMethodArgumentNotValidException(HttpServletRequest servletRequest) {
		return badRequest("https://socialbooks.batalhao.com.br/400/MethodArgumentNotValidException");
	}
